...
public class Board {
	...
	//as the name suggests the checks idf the game is over
	...
	// this function check for any legit combination 
...
//return a list with empty cells for computer use 
...
// this will bring the max value 
	...
	// the com puter decides what is the best move
	...
	public int minimax(int depth, CellState player) {
		...
		else if(isWinning(CellState.USER)) {
			return -1 ;
